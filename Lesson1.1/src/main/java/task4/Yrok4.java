...
//        Массив не имеет повторяющихся элементов
        ...
        // НУЖНА ПОМОЩЬ! Не могу вывести фразу(Массив имеет повторяющиеся элементы и Массив не имеет повторяющихся элементов)
        // потому что если вставляю вывод фразы в цикл, фраза задваивается. А если писать выво за циклом, то ругается, что
        // цикл закрыт и не могу обращаться к mass[i] и mass[j]. Код ниже работает(заполняет массив и проверяет его элементы на
        // повторения), вопрос только с выводом.
